...
const ABI = require('../artifacts/contracts/Rcontract.sol/Rcontract.json');
...
async function main() {
  ...
  const NFT = await ethers.getContractFactory("Rcontract");
  const nft = await NFT.attach('0x750c242947B0dC72D0e7e0437e8a05385627BF83');
  ...
  console.log("RiyaNFT wallet balance", wallet.address, "is: ", balance.toString());
}

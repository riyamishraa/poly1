// This script batch mints Rcontract ERC721A tokens.
...
async function main() {
  ...
  const contractAddress = "0x750c242947B0dC72D0e7e0437e8a05385627BF83";

  // Get the contract factory and attach it to the signer
  const Rcontract = await ethers.getContractFactory("Rcontract", signer);
  const contract = await Rcontract.attach(contractAddress);
